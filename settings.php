...
// Override in local-settings.php
$databases = array (
  'default' => 
  array (
    'default' => 
 ...
 *
 */
$drupal_hash_salt = 'EvpXkDV3xaJlbtqFNO4bBaFMrE9fj9YEHRRpAiollLA';
...
# Allow local builds to override settings. If file does not exist, just touch local-settings.php to create empty file.
